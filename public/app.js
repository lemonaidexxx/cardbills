...
const intro=el('section','overview-intro');append(intro,el('h2','','Your finances, clearly organized.'),button('Review transactions',()=>navigate('Review'),'secondary'));c.append(intro);
    ...
    const activity=el('section','card');append(activity,el('h2','','Recorded spending by posting month'));
